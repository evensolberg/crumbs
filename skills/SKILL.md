...
- `crumbs list` output format: `icon id [Px] [phase] [type] title [tags] due:… [Nsp]` — phase badge is padded to the widest phase in the current view; unphased items show `[ ]` (spaces)
